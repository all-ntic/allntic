      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <span className="text-2xl font-bold gradient-text">ALLNTIC</span>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-card/50 backdrop-blur-sm rounded-lg mt-2 shadow-card animate-fade-in">
              {navItems.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
